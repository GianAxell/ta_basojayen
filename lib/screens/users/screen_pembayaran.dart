...
import 'screen_status_pesanan.dart'; // Menghubungkan ke halaman status pesanan

class PaymentScreen extends StatefulWidget {
  final int totalAmount; // Menerima total harga dari data keranjang
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            Text(
              'Total Pembayaran: Rp. ${widget.totalAmount}',
