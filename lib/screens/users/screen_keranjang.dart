...
class ScreenKeranjang extends StatefulWidget {
  ...
  const ScreenKeranjang({super.key, required this.selectedItems, this.tableNumber = ''});
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: Center(
              child: MenuImage(imagePath: item.imagePath, size: 60),
            ),
          ),
        ...
        children: [
                ...
                return Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        'Rp. ${NumberFormat('#,##0', 'id_ID').format(item.priceValue * item.quantity)}', 
                        style: GoogleFonts.inter(color: Colors.white.withOpacity(0.9), fontSize: 14)
                      ),
                    ],
                  ),
          ...
          Row(
            ...
            children: [
              ...
              Text('Rp. ${NumberFormat('#,##0', 'id_ID').format(subtotal)}', style: GoogleFonts.inter(fontWeight: FontWeight.bold, fontSize: 18, color: Colors.white)),
            ],
          ),
          const SizedBox(height: 20),
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => CustomerDataScreen(totalAmount: subtotal, selectedItems: widget.selectedItems, tableNumber: widget.tableNumber),
                ),
              );
            },
